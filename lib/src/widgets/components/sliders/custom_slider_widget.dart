...
class RMSliderWidget extends StatefulWidget {
  const RMSliderWidget({
    super.key,
    required this.min,
    required this.max,
  ...
  @override
  State<RMSliderWidget> createState() => _RMSliderWidgetState();
}

class _RMSliderWidgetState extends State<RMSliderWidget> {
