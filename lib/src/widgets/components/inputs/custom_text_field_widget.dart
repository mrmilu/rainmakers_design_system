...
class RMTextFieldWidget extends StatefulWidget {
  ...
  @override
  State<RMTextFieldWidget> createState() => _RMTextFieldWidgetState();
}

class _RMTextFieldWidgetState extends State<RMTextFieldWidget> {
