...
class RMCustomExpandableWidget extends StatefulWidget {
  final String title;
  ...
  const RMCustomExpandableWidget({
    super.key,
    required this.title,
    this.subtitle = '',
  ...
  @override
  State<RMCustomExpandableWidget> createState() =>
      _RMCustomExpandableWidgetState();
}

class _RMCustomExpandableWidgetState extends State<RMCustomExpandableWidget>
