...
/// )
/// ```
class RMButtonScaleWidget extends StatefulWidget {
  const RMButtonScaleWidget({
    super.key,
    required this.onTap,
    required this.child,
  ...
  @override
  State<RMButtonScaleWidget> createState() => _RMButtonScaleWidgetState();
}

class _RMButtonScaleWidgetState extends State<RMButtonScaleWidget>
